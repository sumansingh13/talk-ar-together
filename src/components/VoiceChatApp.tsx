...
const VoiceChatApp = () => {
  ...
  const channels = [
    { id: 1, name: 'General', users: 12, private: false },
    { id: 2, name: 'Tech Talk', users: 8, private: false },
    { id: 3, name: 'Gaming Zone', users: 15, private: false },
    { id: 4, name: 'Study Group', users: 6, private: true },
  ];
